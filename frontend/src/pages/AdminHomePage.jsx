...
const isAuthError = (error) => {
  ...
  return msg.toLowerCase().includes('not authorized') || msg.toLowerCase().includes('unauthorized');
};
...
const AdminHomePage = () => {
  ...
  useEffect(()=>{
    ...
    // Listen for product updates from OrderManagement
    ...
    return (
        <div className="max-w-7xl mx-auto p-6">
            ...
            {productsLoading || ordersLoading ? (
                <p>Loading...</p>
            ): productsError && !isAuthError(productsError) ? (
                <p className="text-red-500">Error fetching products: {getErrorMessage(productsError)}</p>
            ) : ordersError ? (
                <p className="text-red-500">Error fetching orders: {getErrorMessage(ordersError)}</p>
            ):(
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div className="p-4 shadow-md rounded-lg">
                    ...
                    <p className="text-2xl">{Array.isArray(products) ? products.length : 0}</p>
